...
namespace UniRx
{
    ...
    public static partial class ObservableWWW
    {
        ...
        public static IObservable<string> PostAndGetBytes(string url, string json)
        {
            return ObservableUnity.FromCoroutine<string>((observer, cancellation) => FetchText( UnityWebRequest.Put(url, json), observer, null, cancellation));
        }
